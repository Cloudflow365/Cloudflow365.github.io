      ...
      <div className="container mx-auto px-8 lg:flex">
        <div className="text-center lg:text-left lg:w-1/2">
          ...
          <p className="text-xl lg:text-2xl mt-6 font-light">
            ...
            information or to talk about a project you need assistance with please drop us an email
            on <a href="mailto:support@cloudflow365.com">support@cloudflow365.com</a> and we'll
            arrange a call.
          </p>
        </div>
